...
```
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-queen-c778
```

A live public deployment of this template is available at [https://snowy-queen-c778.templates.workers.dev](https://snowy-queen-c778.templates.workers.dev)
